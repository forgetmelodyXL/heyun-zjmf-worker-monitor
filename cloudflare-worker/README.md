...
1. Fork 本仓库。
2. [点击下载 步骤1-一键安装.bat](https://github.com/loqwe/heyun-zjmf-worker-monitor/raw/main/windows-one-click-deploy/%E6%AD%A5%E9%AA%A41-%E4%B8%80%E9%94%AE%E5%AE%89%E8%A3%85.bat)，保存到你想部署的目录。
   如果浏览器直接打开脚本文本，按 `Ctrl + S` 另存为 `步骤1-一键安装.bat`。
3. 准备 Cloudflare Token、Account ID、Fork 后的仓库地址和魔方财务 API。
4. 双击 `步骤1-一键安装.bat`，按提示填写信息。
