...
> 打开 [EdgeOne Pages 控制台](https://console.cloud.tencent.com/edgeone/pages)，点击 **导入其它仓库**，选择现有 GitHub 仓库。
...
1. 打开 [EdgeOne Pages 控制台](https://console.cloud.tencent.com/edgeone/pages)，点击 **导入其它仓库**。
